		...
		<?php foreach ( $downloads as $download ) : ?>
			<li>
				...
				if ( is_numeric( $download['downloads_remaining'] ) ) {
					...
					echo apply_filters( 'woocommerce_available_download_count', '<span class="woocommerce-Count count">' . sprintf( _n( __('%s download remaining', 'atzi'), __('%s downloads remaining', 'atzi'), $download['downloads_remaining'], 'woocommerce' ), $download['downloads_remaining'] ) . '</span> ', $download ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				}
